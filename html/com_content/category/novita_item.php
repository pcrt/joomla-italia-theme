    ...
    <article class="card card-bg card-article card-article-greendark">    
        <div class="card-body">
            <div class="card-article-img d-none d-lg-block">
                ...
                <a href="<?php echo Route::_(RouteHelper::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>" title="service-link"><svg class="icon-greendark svg-newspaper"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/templates/joomla-italia-theme/svg/sprites.svg#it-note"></use></svg></a>
                <?php } else{ 
