...
<div class="container mod-news">
    ...
    if ($module->showtitle) {
        ...
        foreach ($list as $item) :
            if($countcat == 0){
                echo '<div><a href="index.php/'.$item->category_route.'">Vedi tutti</a><svg class="icon icon-xs d-inline-block"><use xlink:href="/templates/pcrt-sibilla/svg/sprites.svg#it-arrow-right"></use></svg></div></div>';
            }
        ++$countcat;
        endforeach;
    }
                ...
                <div class="scheda-item" itemscope itemtype="https://schema.org/Article">
                    <div class="categoria-ico my-2">            
                        <svg class="icon icon-xs d-inline-block">
                            <use xlink:href="/templates/pcrt-sibilla/svg/sprites.svg#it-calendar"></use>
                        </svg>
